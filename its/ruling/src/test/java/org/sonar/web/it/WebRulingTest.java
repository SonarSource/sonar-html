...
public class WebRulingTest {
  ...
  public static OrchestratorRule orchestrator = OrchestratorRule.builderEnv()
    ...
    .addPlugin(MavenLocation.of("org.sonarsource.sonar-lits-plugin", "sonar-lits-plugin", "0.13.0.6110"))
    .build();
  ...
  public static void prepare_quality_profiles() {
    ...
    instantiateTemplateRule("S8687", "Template_AllowedLang", "languages=\"en,fr\"");
