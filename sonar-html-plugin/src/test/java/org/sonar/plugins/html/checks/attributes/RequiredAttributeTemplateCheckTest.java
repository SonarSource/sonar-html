...
class RequiredAttributeTemplateCheckTest {
  ...
  @Test
  void detected() {
    assertThat(new RequiredAttributeTemplateCheck().attributes).isEmpty();
  }

  @Test
  void custom() {
    RequiredAttributeTemplateCheck check = new RequiredAttributeTemplateCheck();
