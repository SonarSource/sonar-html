...
```bash
sonar analyze agentic --project org.sonarsource.html:html --depth DEEP --file <path/to/file1> --file <path/to/file2>
```
...
```bash
sonar analyze agentic --project org.sonarsource.html:html --depth DEEP
```
